		...
		<div id="content">
			<div id="buylist">
				...
				<div class="newgoods"><ul>
						<?php if(is_array($goods_cate)): $k = 0; $__LIST__ = array_slice($goods_cate,0,6,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li>
