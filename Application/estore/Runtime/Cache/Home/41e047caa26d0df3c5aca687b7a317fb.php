...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form action="<?php echo U('Home/Index/isLogin');?>" method="post">
      ...
      <div class="formRow yzm">
        ...
        <img src="<?php echo U('Home/Index/verify');?>" onclick="this.src='<?php echo U('Home/Index/verify');?>?code='+Math.random()"></div>
     <!--  <div class="formRow">
        <label for="online">
