...
<div class="pd-20">
  <div class="Huiform">
    <form action="<?php echo U('Home/Address/addressEditHandle');?>"  method="post">
      <table class="table table-bg">
      <input type="hidden" name="id" value="<?php echo ($id); ?>" />
        <tbody>
          <tr>
            <th width="100" class="text-r"><span class="c-red">*</span> 收货地址名称：</th>
            <td><input type="text" style="width:200px" class="input-text" value="<?php echo ($address['address']); ?>" placeholder="" id="user-name" name="address_name" datatype="*2-16" nullmsg="地址名称不能为空"></td>
          </tr>
           <tr>
            <th width="100" class="text-r"><span class="c-red">*</span> 收货地址邮箱 :</th>
            <td><input type="text" style="width:200px" class="input-text" value="<?php echo ($address['email']); ?>" placeholder="例如:373045134@qq.com" id="address_email" name="address_email" datatype="*2-16" nullmsg="邮箱不能为空"></td>
          </tr>
          <tr>
            <th class="text-r"><span class="c-red">*</span>收货地址电话:</th>
            <td><input type="text" style="width:300px" class="input-text" value="<?php echo ($address['tel']); ?>" placeholder="例如:183xxxxxxxx" id="address_tel" name="address_tel"></td>
          </tr>
          <tr>
            <th></th>
